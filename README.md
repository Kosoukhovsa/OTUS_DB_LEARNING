...
Может выполнять все операции в базе данных, включая резервное копирование, создание/изменение объектов и таблиц, а также чтение и редактирование данных.


- **Manager** - Менеджер каталога товаров.

Может читать данные из всех таблиц и редактировать данные в определённых таблицах, связанных с каталогом товаров ***(book, genre, book_genre, publisher)***.

- **Customer** - Обычный пользователь сайта.

Может читать данные из всех таблиц и редактировать данные в таблице ***review***.

**Пользователи**:

- **books_admin** - Наследует роль Admin
- **manager_1 и manager_2** - Наследуют роль Manager
